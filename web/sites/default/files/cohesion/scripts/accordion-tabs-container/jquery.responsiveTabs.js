...
(function ($, once, window, undefined) {
  ...
  ResponsiveTabs.prototype.init = function () {
    ...
    this.$element.bind('tabs-load', function (e) {
      ...
      if ((_this.options.startCollapsed !== true && _this.options.startCollapsed !== "true") && !(_this.options.startCollapsed === 'accordion' && _this.state === 'accordion')) {
  ...
  ResponsiveTabs.prototype._loadElements = function () {
    ...
    once('tab-init', $('> .' + _this.options.classes.accordionTitle, wrapper)).forEach(function (e, i) {
